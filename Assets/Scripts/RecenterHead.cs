...
public class RecenterHead : MonoBehaviour
{
    ...
    public IEnumerator RunRecenter()
    {
        isActive = true;
    ...
    void OnDestroy()
    {
        // moving target is a child of a dontdestroyonload object therefore we need to destroy it manually
